...
let initwebRoutes = (app) => {
  ...
  router.delete(
    "/api/delete-comment-by-commentId",
    middlewareControllers.verifyTokenAdmin,
  ...
  router.get("/api/vnpay_ipn", shopCartController.vnpayIpn);
  router.post("/api/create-payment", shopCartController.createPaymentUrl);
  router.post("/api/chatbot_webhook", shopCartController.chatbotWebhook);
